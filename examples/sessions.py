...
def main() -> None:
	...
	turns = [{"role": "user", "content": "My name is Alice. Remember it."},
	...
	for turn in turns:
		history.append(turn)
		response = service.chat(messages=history, model="llama-3.3-70b-versatile", session_id=SESSION_ID, )
	...
	if stats:
		...
		print(f"Session stats: {stats.get('total_requests')} requests, "
