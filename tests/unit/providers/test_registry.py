"""Unit tests for poolgate/providers/registry.py — assert_capability and models_for."""
...
from poolgate.providers.registry import assert_capability, MODEL_CAPABILITIES, models_for
