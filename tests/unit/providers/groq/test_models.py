"""Unit tests for poolgate/providers/groq/models.py — registry, factory, env overrides, validation."""

from __future__ import annotations

import pytest

from poolgate.exceptions.configuration import InvalidRateLimitConfigError
from poolgate.exceptions.request import UnknownModelError
from poolgate.providers.groq.models import (
    get_model_config,
    Llama3370BVersatileConfig,
    MODEL_REGISTRY,
    ModelRateLimitConfig,
)
from poolgate.providers.registry import MODEL_CAPABILITIES
