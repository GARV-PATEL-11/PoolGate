"""
Tests for poolgate/capabilities/chat.py.

The first test in this file (test_chat_client_is_instantiable) is the
canary / regression guard for the audit's most critical finding: ChatCapability
...
from poolgate.capabilities.chat import ChatCapability as ChatClient
