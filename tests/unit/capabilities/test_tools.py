"""Unit tests for capabilities/tools.py."""
...
from poolgate.capabilities.tools import ToolCapability as ToolClient
from poolgate.schemas.common.runtime import FinishReason, RequestConfig
