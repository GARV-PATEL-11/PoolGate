"""Unit tests for poolgate/pool/strategies/ — pure logic, no mocking needed."""
...
class TestWeightedRoundRobinStrategy:
    ...
    def test_higher_weight_key_selected_more_often(self, three_keys, groq_config):
        ...
        strategy = WeightedRoundRobinStrategy()
        selections = [strategy.select(three_keys, three_keys, groq_config).key_id for _ in range(10)]
