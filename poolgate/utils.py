...
class SlidingWindowCounter:
    """Thread-safe sliding-window request counter. Counts events in the last `window_seconds`."""
...
class LatencyTracker:
    """Thread-safe rolling latency tracker. Keeps last `max_samples` measurements."""
