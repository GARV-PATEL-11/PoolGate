"""QuotaTracker — tracks provider-reported quota per model."""
...
class QuotaTracker:
    """Thread-safe store of the most recently observed provider quota per model."""
    ...
    def get_remaining(self, model: str) -> dict[str, Any]:
