    ...
    def from_env(cls) -> ModelRateLimitConfig:
        ...
        return cls(
            ...
            audio_seconds_per_hour=cls._env_int(
                f"{p}_AUDIO_SECONDS_PER_HOUR",
                defaults.audio_seconds_per_hour,
            ),
            audio_seconds_per_day=cls._env_int(
                f"{p}_AUDIO_SECONDS_PER_DAY",
                defaults.audio_seconds_per_day,
            ),
            input_tokens_per_minute=cls._env_int(
                f"{p}_INPUT_TOKENS_PER_MINUTE",
                defaults.input_tokens_per_minute,
            ),
            output_tokens_per_minute=cls._env_int(
                f"{p}_OUTPUT_TOKENS_PER_MINUTE",
                defaults.output_tokens_per_minute,
            ),
        )
