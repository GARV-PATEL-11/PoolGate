...
class ModelRateLimitConfig:
	...
	def active_limits(self) -> dict[str, int]:
		...
		keys = ("requests_per_minute", "requests_per_day", "tokens_per_minute", "tokens_per_day", "audio_seconds_per_hour", "audio_seconds_per_day", "input_tokens_per_minute", "output_tokens_per_minute")
