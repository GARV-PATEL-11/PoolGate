...
class GptOss20BConfig(ModelRateLimitConfig):
	...
	Env-var overrides (all optional; class defaults apply when unset):
			GROQ_MODEL_GPT_OSS_20B_REQUESTS_PER_MINUTE – requests / minute  (default: 30)
			GROQ_MODEL_GPT_OSS_20B_REQUESTS_PER_DAY    – requests / day         (default: 1,000)
			GROQ_MODEL_GPT_OSS_20B_TOKENS_PER_MINUTE   – tokens    / minute   (default: 8,000)
			GROQ_MODEL_GPT_OSS_20B_TOKENS_PER_DAY      – tokens    / day         (default: 200,000)
			GROQ_MODEL_GPT_OSS_20B_INPUT_TOKENS_PER_MINUTE  – input tokens  / minute  (default: None — only if split limits apply)
			GROQ_MODEL_GPT_OSS_20B_OUTPUT_TOKENS_PER_MINUTE – output tokens / minute  (default: None — only if split limits apply)
	"""
